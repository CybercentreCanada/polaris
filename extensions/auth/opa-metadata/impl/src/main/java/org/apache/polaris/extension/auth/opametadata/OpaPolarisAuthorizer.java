...
import org.apache.polaris.extension.auth.opametadata.model.ImmutableOpaRequest;
import org.apache.polaris.extension.auth.opametadata.model.ImmutableResource;
import org.apache.polaris.extension.auth.opametadata.model.ImmutableResourceEntity;
import org.apache.polaris.extension.auth.opametadata.model.ResourceEntity;
...
class OpaPolarisAuthorizer implements PolarisAuthorizer {
  ...
  public AuthorizationDecision authorize(
      @NonNull AuthorizationState authzState, @NonNull AuthorizationRequest request) {
    LOGGER.info("authorize:125 Authorizing request: {}", request.formatForAuthorizationMessage());
    boolean allowed =
        queryOpa(
